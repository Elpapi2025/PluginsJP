package me.juanpiece.titan.modules.api;
...
public class TitanAPI {
    ...
    public TitanAPI(JavaPlugin plugin) {
        Plugin hcf = plugin.getServer().getPluginManager().getPlugin("Titan");

        if (hcf == null) {
            throw new IllegalArgumentException("Titan is not loaded");
        }
