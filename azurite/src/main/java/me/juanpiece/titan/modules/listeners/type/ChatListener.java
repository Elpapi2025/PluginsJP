...
public class ChatListener extends Module<ListenerManager> {
    ...
    public void onChat(AsyncPlayerChatEvent e) {
        ...
        String message = (player.hasPermission("titan.chat.color") ? CC.t(e.getMessage()) : e.getMessage());
        String killTop = "";
        String ftop = "";
        ...
        boolean bypassed = player.hasPermission("titan.chat.bypass");
        ...
        if (!player.hasPermission("titan.profanity.bypass") && chatType == TeamChatSetting.PUBLIC) {
        ...
        switch (chatType) {
            case STAFF:
                ...
                for (Player recipient : e.getRecipients()) {
                    if (recipient.hasPermission("titan.staff")) {
