...
import me.juanpiece.titan.modules.versions.type.Version1_7_R4;
...
public class SetRepairCommand extends Command {
    ...
    public SetRepairCommand(CommandManager manager) {
        ...
        this.setPermissible("titan.setrepair");

        this.clickAll = Serializer.deserializeLoc(getMiscConfig().getString("REPAIR_LOC_ALL"));
        this.clickHand = Serializer.deserializeLoc(getMiscConfig().getString("REPAIR_LOC_HAND"));
