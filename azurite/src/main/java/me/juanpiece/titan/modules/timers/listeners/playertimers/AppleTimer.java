...
public class AppleTimer extends PlayerTimer {
    ...
    public AppleTimer(TimerManager manager) {
        super(
                ...
                "Apple",
                "PLAYER_TIMERS.APPLE",
                manager.getConfig().getInt("TIMERS_COOLDOWN.APPLE")
        );
    ...
    public void reload() {
        ...
        this.seconds = getConfig().getInt("TIMERS_COOLDOWN.APPLE");
    }
    ...
    public void onEat(PlayerItemConsumeEvent e) {
        ...
        if (item.getType() == Material.GOLDEN_APPLE && getInstance().getVersionManager().getVersion().isNotGapple(item)) {
