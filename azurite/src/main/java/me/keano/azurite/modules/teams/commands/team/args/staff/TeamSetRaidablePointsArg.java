 ...
 */
public class TeamSetRaidablePointsArg extends Argument {

    public TeamSetRaidablePointsArg(CommandManager manager) {
        super(
                manager,
                Arrays.asList(
                        "setraidablepoints",
        ...
        this.setPermissible("azurite.team.setraidablepoints");
    }

    @Override
    public String usage() {
        return getLanguageConfig().getString("ADMIN_TEAM_COMMAND.TEAM_SETRAIDABLEPOINTS.USAGE");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        pt.setRaidablePoints(amount);
        pt.save();

        sendMessage(sender, getLanguageConfig().getString("ADMIN_TEAM_COMMAND.TEAM_SETRAIDABLEPOINTS.SETPOINTS")
                .replace("%team%", args[0])
