...
public class TeamSetCapsArg extends Argument {
    ...
    public TeamSetCapsArg(CommandManager manager) {
        ...
        this.setPermissible("azurite.team.setcaps");
    }

    @Override
    public String usage() {
        return getLanguageConfig().getString("ADMIN_TEAM_COMMAND.TEAM_SETCAPTURES.USAGE");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        pt.setKothCaptures(amount);
        pt.save();

        sendMessage(sender, getLanguageConfig().getString("ADMIN_TEAM_COMMAND.TEAM_SETCAPTURES.SETCAPTURES")
                .replace("%team%", args[0])
