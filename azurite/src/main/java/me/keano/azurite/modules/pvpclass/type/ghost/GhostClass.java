...
public class GhostClass extends PvPClass {
    ...
    public void handleUnequip(Player player) {
        if (invisible.remove(player.getUniqueId())) {
    ...
    public void onDamage(EntityDamageByEntityEvent e) {
        ...
        if (getClassesConfig().getBoolean("GHOST_CLASS.SHOW_ARMOR_ON_HIT.ENABLED") && ghostData.getMode().equals(
                getClassesConfig().getString("GHOST_CLASS.SHOW_ARMOR_ON_HIT.MODE")) && invisible.remove(damaged.getUniqueId())) {
