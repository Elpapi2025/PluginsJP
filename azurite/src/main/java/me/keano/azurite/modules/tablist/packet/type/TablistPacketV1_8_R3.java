...
public class TablistPacketV1_8_R3 extends TablistPacket {
        ...
        for (int row = 0; row < 20; row++) {
            for (int col = 0; col < maxColumns; col++) {
                ...
                if (maxColumns > 3) {
                    ...
                    IChatBaseComponent component = IChatBaseComponent.ChatSerializer.a("{\"text\":\"" + entry.getText() + "\"}");
    ...
    private void sendHeaderFooter() {
        ...
        PacketPlayOutPlayerListHeaderFooter packet = new PacketPlayOutPlayerListHeaderFooter(
                IChatBaseComponent.ChatSerializer.a("{\"text\":\"" + headerJoined + "\"}")
        );

        try {

            FOOTER_FIELD.set(packet, IChatBaseComponent.ChatSerializer.a("{\"text\":\"" + footerJoined + "\"}"));
