...
public class KitSetCooldownArg extends Argument {
    ...
    @Override
    public String usage() {
        return getLanguageConfig().getString("KIT_COMMAND.KIT_SETCOOLDOWN.USAGE");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        sendMessage(sender, getLanguageConfig().getString("KIT_COMMAND.KIT_SETCOOLDOWN.SET_COOLDOWN")
