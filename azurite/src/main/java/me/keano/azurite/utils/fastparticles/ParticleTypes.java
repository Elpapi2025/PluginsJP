package me.keano.azurite.utils.fastparticles;

import me.keano.azurite.modules.board.fastboard.FastReflection;
...
final class ParticleTypes {
    ...
    public static Method CREATE_BLOCK_DATA;
    public static Method SPAWN_PARTICLE_WORLD;
    public static Method SPAWN_PARTICLE_PLAYER;
    ...
    static {
        ...
        if (MODERN) {
            CREATE_BLOCK_DATA = ReflectionUtils.accessMethod(Bukkit.class, "createBlockData", Material.class);
            SPAWN_PARTICLE_WORLD = ReflectionUtils.accessMethod(World.class, "spawnParticle",
                    Particle.class, double.class, double.class, double.class, int.class, double.class, double.class, double.class, double.class, Object.class
            );
            SPAWN_PARTICLE_PLAYER = ReflectionUtils.accessMethod(Player.class, "spawnParticle",
                    Particle.class, double.class, double.class, double.class, int.class, double.class, double.class, double.class, double.class, Object.class
            );
        }
    }
    ...
    static final class DefaultParticleType implements ParticleType {
        ...
        public <T> void spawn(World world, double x, double y, double z, int count, double offsetX, double offsetY, double offsetZ, double extra, T data) {
            ...
            try {
                ...
                SPAWN_PARTICLE_WORLD.invoke(world, this.particle, x, y, z, count, offsetX, offsetY, offsetZ, extra, newData);
        ...
        public <T> void spawn(Player player, double x, double y, double z, int count, double offsetX, double offsetY, double offsetZ, double extra, T data) {
            ...
            try {
                ...
                SPAWN_PARTICLE_PLAYER.invoke(player, this.particle, x, y, z, count, offsetX, offsetY, offsetZ, extra, newData);
        ...
        private Object mapData(Object data) {
            ...
            if (dataType == BLOCK_DATA_CLASS && data instanceof MaterialData) {
                try {
                    ...
                    return CREATE_BLOCK_DATA.invoke(null, ((MaterialData) data).getItemType());
