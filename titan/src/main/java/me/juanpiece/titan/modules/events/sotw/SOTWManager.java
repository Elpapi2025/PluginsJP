package me.juanpiece.titan.modules.events.sotw;

import lombok.Getter;
import lombok.Setter;
import me.juanpiece.titan.HCF;
import me.juanpiece.titan.modules.events.sotw.listener.SOTWListener;
...
public class SOTWManager extends Manager {
    ...
    public boolean canFly(Player player, Team at) {
        // Anywhere
        if (getConfig().getBoolean("SOTW_FLY.ALLOW_ANYWHERE") && player.hasPermission("titan.sotw.fly.anywhere")) {
            return true;
        }
