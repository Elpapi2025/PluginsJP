package me.juanpiece.titan.modules.events.sotw.command;
...
public class SOTWCommand extends Command {
    ...
    public void sendUsage(CommandSender sender) {
        if (sender.hasPermission("titan.sotw.admin")) {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        switch (args[0].toLowerCase()) {
            ...
            case "fly":
                if (!sender.hasPermission("titan.sotw.fly")) {
                    sendMessage(sender, Config.INSUFFICIENT_PERM);
                    return;
                }
            ...
            case "enable":
                ...
                if (sotwManager.getEnabled().contains(enable.getUniqueId())) {
