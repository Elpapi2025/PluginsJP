...
public class TeamSetPointsArg extends Argument {
    ...
    public TeamSetPointsArg(CommandManager manager) {
        ...
        this.setPermissible("titan.team.setpoints");
    }

    @Override
    public String usage() {
        return getLanguageConfig().getString("ADMIN_TEAM_COMMAND.TEAM_SETPOINTS.USAGE");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        sendMessage(sender, getLanguageConfig().getString("ADMIN_TEAM_COMMAND.TEAM_SETPOINTS.SETPOINTS")
                .replace("%team%", args[0])
