...
import me.juanpiece.titan.modules.teams.type.WarzoneTeam;
import me.juanpiece.titan.modules.teams.type.WildernessTeam;
...
public class TeamClaimArg extends Argument {
    ...
    public void onInteract(PlayerInteractEvent e) {
        ...
        if (!player.hasPermission("titan.claim.bypass") && player.getWorld().getEnvironment() != World.Environment.NORMAL) {
        ...
        // Purchase & Claim need to be above the rest - juanpiece
        ...
        if ((e.getAction() == Action.LEFT_CLICK_AIR || e.getAction() == Action.LEFT_CLICK_BLOCK) && player.isSneaking()) {
            ...
            boolean bypass = player.hasPermission("titan.claim.nomoney");
