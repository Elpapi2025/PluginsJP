    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (targetObject != null) {
            FancyMessage fancyMessage = new FancyMessage(getLanguageConfig().getString("TEAM_COMMAND.TEAM_INVITE.MESSAGE_INVITE")
                    ...
                    .tooltip(getLanguageConfig().getStringList("TEAM_COMMAND.TEAM_INVITE.HOVER"))
        ...
        // remove 3 mins later
        Tasks.executeLater(getManager(), (20 * 60) * 3, () -> pt.getInvitedPlayers().remove(target.getUniqueID()));
    }
}