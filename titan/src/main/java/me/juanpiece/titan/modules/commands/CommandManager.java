package me.juanpiece.titan.modules.commands;

import me.juanpiece.titan.HCF;
import me.juanpiece.titan.modules.ability.command.AbilitiesCommand;
import me.juanpiece.titan.modules.ability.command.AbilityCommand;
import me.juanpiece.titan.modules.commands.type.*;
import me.juanpiece.titan.modules.commands.type.essential.*;
import me.juanpiece.titan.modules.deathban.command.DeathbanCommand;
import me.juanpiece.titan.modules.events.conquest.command.ConquestCommand;
import me.juanpiece.titan.modules.events.eotw.command.EOTWCommand;
import me.juanpiece.titan.modules.events.king.command.KingCommand;
import me.juanpiece.titan.modules.events.koth.command.KothCommand;
import me.juanpiece.titan.modules.events.purge.command.PurgeCommand;
import me.juanpiece.titan.modules.events.sotw.command.SOTWCommand;
import me.juanpiece.titan.modules.framework.Manager;
import me.juanpiece.titan.modules.framework.commands.Command;
import me.juanpiece.titan.modules.killstreaks.command.KillstreakCommand;
import me.juanpiece.titan.modules.killtag.command.KilltagCommand;
import me.juanpiece.titan.modules.kits.commands.KitCommand;
import me.juanpiece.titan.modules.reclaims.command.DailyCommand;
import me.juanpiece.titan.modules.reclaims.command.ReclaimCommand;
import me.juanpiece.titan.modules.reclaims.command.ResetDailyCommand;
import me.juanpiece.titan.modules.reclaims.command.ResetReclaimCommand;
import me.juanpiece.titan.modules.scheduler.command.SchedulesCommand;
import me.juanpiece.titan.modules.spawners.command.SpawnerCommand;
import me.juanpiece.titan.modules.staff.command.*;
import me.juanpiece.titan.modules.teams.commands.citadel.CitadelCommand;
import me.juanpiece.titan.modules.teams.commands.mountain.MountainCommand;
import me.juanpiece.titan.modules.teams.commands.systeam.SysTeamCommand;
import me.juanpiece.titan.modules.teams.commands.team.TeamCommand;
import me.juanpiece.titan.modules.teams.commands.team.args.TeamCampArg;
import me.juanpiece.titan.modules.teams.commands.team.args.TeamHQArg;
import me.juanpiece.titan.modules.timers.command.customtimer.CTimerCommand;
import me.juanpiece.titan.modules.timers.command.keyall.KeyAllCommand;
import me.juanpiece.titan.modules.timers.command.timer.TimerCommand;
...
public class CommandManager extends Manager {
    ...
    public CommandManager(HCF instance) {
        ...
        instance.getVersionManager().getVersion().getCommandMap().registerAll("titan", commands
                .stream()
    ...
    private void checkCommands() {
        ...
        while (iterator.hasNext()) {
            ...
            if (command.getName().equalsIgnoreCase("TITAN")) continue;
    ...
    public void reload() {
        ...
        for (Command command : commands) {
            ...
            boolean isTitanCommand = bukkitCommand.getLabel().split(":")[0].equalsIgnoreCase("titan");
        ...
        map.registerAll("titan", commands
                .stream()
                .map(Command::asBukkitCommand)
                .collect(Collectors.toList())
        );
