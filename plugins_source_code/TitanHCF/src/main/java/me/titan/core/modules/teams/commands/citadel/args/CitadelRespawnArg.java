package me.titan.core.modules.teams.commands.citadel.args;

import me.titan.core.modules.commands.CommandManager;
import me.titan.core.modules.framework.commands.Argument;
import me.titan.core.modules.teams.Team;
import me.titan.core.modules.teams.type.CitadelTeam;
...
public class CitadelRespawnArg extends Argument {
    @Override
    public String usage() {
        return this.getLanguageConfig().getString("CITADEL_COMMAND.CITADEL_RESPAWN.USAGE");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        team.resetBlocks();
        this.sendMessage(sender, this.getLanguageConfig().getString("CITADEL_COMMAND.CITADEL_RESPAWN.RESPAWNED").replaceAll("%citadel%", team.getName()));
    }
}
