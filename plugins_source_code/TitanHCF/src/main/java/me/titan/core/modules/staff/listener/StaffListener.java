package me.titan.core.modules.staff.listener;
...
import me.titan.core.modules.staff.menu.InspectionMenu;
import me.titan.core.modules.staff.menu.SilentViewMenu;
...
public class StaffListener extends HCFModule<StaffManager> {
    ...
    public void onJoinVanish(PlayerJoinEvent event) {
        Player player = event.getPlayer();
        if (player.hasPermission("titan.vanish")) {
            return;
        }
        for (UUID uuid : this.getManager().getVanished()) {
    ...
    public void onJoin(PlayerJoinEvent event) {
        Player player = event.getPlayer();
        if (player.hasPermission("titan.staff") && this.getConfig().getBoolean("STAFF_MODE.STAFF_MODE_ON_JOIN")) {
            player.chat("/staff");
        }
    }
