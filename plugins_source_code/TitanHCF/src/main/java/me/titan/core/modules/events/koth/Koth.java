package me.titan.core.modules.events.koth;

import lombok.Getter;
import lombok.Setter;
import me.titan.core.modules.events.EventType;
...
import me.titan.core.utils.cuboid.Cuboid;
...
@Getter
@Setter
public class Koth extends HCFModule<KothManager> {
    ...
    public void reward() {
        ...
        for (String s : this.getConfig().getStringList("KOTHS_CONFIG.COMMANDS_ON_CAPTURE")) {
            Tasks.execute(this.getManager(), () -> Bukkit.dispatchCommand(Bukkit.getConsoleSender(), s));
        }
    }
}
