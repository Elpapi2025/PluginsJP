package me.titan.core.modules.teams.claims;
...
import me.titan.core.modules.teams.type.WarzoneTeam;
import me.titan.core.modules.teams.type.WildernessTeam;
...
public class ClaimManager extends HCFModule<TeamManager> {
    ...
    private boolean canTeleport(Location location) {
        ...
        for (BlockFace face : BlockFace.values()) {
            if (face == BlockFace.DOWN || face == BlockFace.UP || this.getClaim(block.getRelative(face).getLocation()) == null) continue;
            return false;
        }
        return true;
    }
