        ...
        if ((event.getAction() == Action.LEFT_CLICK_AIR || event.getAction() == Action.LEFT_CLICK_BLOCK) && player.isSneaking()) {
            ...
            if (event.getAction() != Action.RIGHT_CLICK_BLOCK) {
                if (event.getAction() == Action.LEFT_CLICK_BLOCK) {
                    ...
                    Tasks.execute(this.getManager(), () -> this.getInstance().getWallManager().sendPillar(player, location));
            ...
            Tasks.execute(this.getManager(), () -> this.getInstance().getWallManager().sendPillar(player, loc2));
