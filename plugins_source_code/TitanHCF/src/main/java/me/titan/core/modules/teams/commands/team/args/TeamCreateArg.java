...
public class TeamCreateArg extends Argument {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        Bukkit.broadcastMessage(this.getLanguageConfig().getString("TEAM_COMMAND.TEAM_CREATE.CREATED_BROADCAST").replaceAll("%team%", name).replaceAll("%player%", player.getName()));
    }
