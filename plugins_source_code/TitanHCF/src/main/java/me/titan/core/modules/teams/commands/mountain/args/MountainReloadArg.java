...
public class MountainReloadArg extends Argument {
    @Override
    public String usage() {
        return this.getLanguageConfig().getString("MOUNTAIN_COMMAND.MOUNTAIN_RELOAD.USAGE");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        team.saveBlocks();
        this.sendMessage(sender, this.getLanguageConfig().getString("MOUNTAIN_COMMAND.MOUNTAIN_RELOAD.RELOADED").replaceAll("%mountain%", team.getName()));
    }
