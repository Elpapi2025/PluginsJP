...
public class Utils {
    ...
    public static int getAmountItems(Manager manager, Player player, ItemStack stack) {
        ...
        for (ItemStack type : contents) {
            if (type == null || type.getType() != stack.getType() || manager.getData(type) != manager.getData(stack)) continue;
            i += type.getAmount();
        }
        return i;
    }
    ...
    public static <E> List<E> createList(Object object, Class<E> clazz) {
        ...
        for (Object o : (List)object) {
            ...
            if (!clazz.isAssignableFrom(o.getClass())) {
                ...
                throw new AssertionError("¡No se puede convertir a lista! La clave " + o + " no es un " + s);
            }
            E e = clazz.cast(o);
            list.add(e);
        }
    ...
    public static boolean verifyPlugin(String pluginName, HCF plugin) {
