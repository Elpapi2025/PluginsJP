...
public class KitSetItemsArg extends Argument {
    ...
    public KitSetItemsArg(CommandManager manager) {
        ...
        this.setPermissible("titan.kit.setitems");
    }

    @Override
    public String usage() {
        return getLanguageConfig().getString("KIT_COMMAND.KIT_SETITEMS.USAGE");
    }
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        sendMessage(sender, getLanguageConfig().getString("KIT_COMMAND.KIT_SETITEMS.SET_ITEMS")
