...
import me.juanpiece.titan.modules.users.extra.StartingBalance;
import me.juanpiece.titan.modules.users.listener.UserListener;
import me.juanpiece.titan.modules.users.task.DonorTask;
import me.juanpiece.titan.modules.users.task.LeaderboardsTask;
...
public class UserManager extends Manager {
    ...
    public int getStartingBalance(Player player) {
        ...
        // This will get the highest priority reclaim.
        for (StartingBalance balance : balances.values()) {
            String perm = "titan.balance." + balance.getName().toLowerCase();
