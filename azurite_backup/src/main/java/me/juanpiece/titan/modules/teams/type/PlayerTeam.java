...
public class PlayerTeam extends Team {
    ...
    public List<String> getTeamInfo(CommandSender sender) {
        ...
        if (sender instanceof Player) {
            ...
            if (isAlly(player) || players.contains(player.getUniqueId()) || sender.hasPermission("titan.staff")) {
    ...
    public void disband(boolean delete) {
        // Titan - Add balance back to leader when disbanding
