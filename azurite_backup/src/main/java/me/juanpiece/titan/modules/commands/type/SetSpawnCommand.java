...
public class SetSpawnCommand extends Command {
    ...
    public SetSpawnCommand(CommandManager manager) {
        ...
        this.setPermissible("titan.setspawn");
    }
    ...
    private void handleWaypoint(Location location) {
        Location old = Serializer.deserializeLoc(getMiscConfig().getString(Utils.getWorldName(location.getWorld()).toUpperCase() + "_SPAWN"));
        Waypoint spawn = getInstance().getWaypointManager().getSpawnWaypoint();
