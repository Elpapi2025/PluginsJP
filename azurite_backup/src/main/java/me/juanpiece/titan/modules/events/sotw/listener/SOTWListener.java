package me.juanpiece.titan.modules.events.sotw.listener;
...
public class SOTWListener extends Module<SOTWManager> {
    ...
    public void onMove(PlayerMoveEvent e) {
        ...
        if (getManager().getEnabled().contains(player.getUniqueId())) return;

        if (to != null && to.isLocked() && !player.hasPermission("titan.lockclaim.bypass")) {
    ...
    public void onDamage(EntityDamageEvent e) {
        ...
        if (getManager().isActive() && !getManager().getEnabled().contains(player.getUniqueId())) {
