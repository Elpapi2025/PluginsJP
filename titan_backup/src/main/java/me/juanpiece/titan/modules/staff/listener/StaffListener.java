package me.juanpiece.titan.modules.staff.listener;

import me.juanpiece.titan.modules.framework.Module;
import me.juanpiece.titan.modules.staff.StaffManager;
import me.juanpiece.titan.modules.staff.extra.StaffItem;
import me.juanpiece.titan.modules.staff.extra.StaffItemAction;
import me.juanpiece.titan.modules.staff.menu.InspectionMenu;
import me.juanpiece.titan.modules.staff.menu.SilentViewMenu;
...
public class StaffListener extends Module<StaffManager> {
    ...
    public void onJoin(PlayerJoinEvent e) {
        ...
        if (player.hasPermission("titan.staff") && getConfig().getBoolean("STAFF_MODE.STAFF_MODE_ON_JOIN")) {
    ...
    public void onJoinVanish(PlayerJoinEvent e) {
        ...
        if (player.hasPermission("titan.vanish")) return;
