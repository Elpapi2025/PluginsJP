...
public class CombatTimer extends PlayerTimer {
    ...
    public CombatTimer(TimerManager manager) {
        super(
                ...
                manager.getConfig().getInt("TIMERS_COOLDOWN.COMBAT_TAG")
        );
    ...
    public void reload() {
        ...
        this.seconds = getConfig().getInt("TIMERS_COOLDOWN.COMBAT_TAG");
        this.blockedCommands = getConfig().getStringList("COMBAT_TIMER.BLOCKED_COMMANDS");
    }
    ...
    public void onCommand(PlayerCommandPreprocessEvent e) {
        ...
        if (hasTimer(player) && !player.hasPermission("titan.combatblock.bypass")) {
            if (message.contains(" ")) {
