...
import me.juanpiece.titan.modules.discord.type.RequestWebhook;
...
public class RequestCommand extends Command {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (staffRequests.size() >= getConfig().getInt("STAFF_MODE.REQUESTS_MENU.SIZE")) staffRequests.clear();
        ...
        for (Player online : Bukkit.getOnlinePlayers()) {
            if (online.hasPermission("titan.staff")) {
